    ...
    <footer style={{ backgroundColor: "rgb(250, 250, 250)" }}>
      <div className="container border-top mt-5">
        <div className="row mt-5">
          <div className="col">
            <img src="media/images/logo.png" alt="logo"style={{ width: "60%" }} />
            <p>
              &copy; 2010 - 2026, Not Tradeonix Broking Ltd. All rights reserved.
            </p>
          </div>
          <div className="col">
            <p>Company</p>
            ...
            <br />
            <a href="/"style={{ textDecoration: "none" }}className="text-muted">Tradeonix.tech</a>
            <br />
            <a href="/"style={{ textDecoration: "none" }}className="text-muted">Press & media</a>
            <br />
            <a href="/"style={{ textDecoration: "none" }}className="text-muted">Tradeonix cares (CSR)</a>
            <br />
          </div>
          <div className="col ">
            <p>Support</p>
        ...
        <div className="mt-5 text-muted" style={{ fontSize: "14px" }}>
          <p>
            Tradeonix Broking Ltd.: Member of NSE​ &​ BSE – SEBI Registration no.:
            INZ000031633 CDSL: Depository services through Tradeonix Securities
            Pvt. Ltd. – SEBI Registration no.: IN-DP-100-2015 Commodity Trading
            through Tradeonix Commodities Pvt. Ltd. MCX: 46025 – SEBI Registration
            no.: INZ000038238 Registered Address: Tradeonix Broking Ltd.,
            #153/154, 4th Cross, Dollars Colony, Opp. Clarence Public School,
            J.P Nagar 4th Phase, Bengaluru - 560078, Karnataka, India. For any
            complaints pertaining to securities broking please write to
            complaints@Tradeonix.com, for DP related to dp@Tradeonix.com. Please
          ...
          <p>
            ...
            claiming to be part of Tradeonix and offering such services, please
            create a ticket here.
          </p>
        </div>
      </div>
      <div className="creator-tag">
  Built by @Amruta Khandekar
</div>
    </footer>
  );
}
